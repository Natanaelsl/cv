---
title: Natanael's Resume"
author: Natanael Soares
date: "`r Sys.Date()`"
output:
...
positions_sheet_loc <- "https://docs.google.com/spreadsheets/d/1LtfUnLPXcRZuNjlGvGKXYg3YjWuSh41NnWO-9pZmy_I"
...
```{r}
position_data %>% print_section('educação')
```
